          ...
          <div className="flex flex-col items-center justify-center mt-16">
            <div className="text-center px-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-wide">
                ScoreStream, Ultimate UET GPA &amp; CGPA Calculator
              </h1>
              ...
              <p className="text-lg max-w-4xl mb-8 leading-relaxed mx-auto">
                ...
                delivering real-time, precise GPA and CGPA computations through
              ...
              <div className="max-w-4xl text-white space-y-6 mx-auto">
                ...
                <ul className="list-disc list-inside space-y-3 text-left">
                  ...
                  <li>
                    <strong>Customizable Semester Tracking:</strong> Easily add
                    or remove semesters and subjects to keep your academic
                    record up to date.
                  </li>
                  <li>
              ...
              <div className="max-w-4xl text-white mt-12 mx-auto">
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  every aspect of this tool, combining modern design with
                  powerful functionality to meet the unique needs of UET Lahore
                  students.
                </p>
              </div>
